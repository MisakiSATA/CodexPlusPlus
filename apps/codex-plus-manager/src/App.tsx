...
const SCRIPT_MARKET_REPOSITORY_URL = "https://github.com/MisakiSATA/CodexPlusPlusScriptMarket";
            ...
            <section className="dream-skin-market">
              <div className="dream-skin-library-head">
                ...
                <Toolbar>
                  ...
                  <Button onClick={() => void actions.openExternalUrl(market?.repositoryUrl || "https://github.com/MisakiSATA/CodexPlusPlus-Themes")} variant="outline">
                    <Github className="h-4 w-4" />
                    {t("投稿主题")}
                  </Button>
                </Toolbar>
